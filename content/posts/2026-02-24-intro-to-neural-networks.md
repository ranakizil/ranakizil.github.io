...
To help the computer understand this, we use a step called **preprocessing**. In this case, we "flatten" the image. Imagine taking each row of the grid and laying them out in one long, straight line, starting from the top-left and ending at the bottom-right.
